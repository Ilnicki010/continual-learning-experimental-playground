...
def train(config_file, export=True):
    ...
    #     configuration["visualization_params"]
    ...
    #     train_batch_size = configuration["train_dataset_params"]["loader_params"][
    #         "batch_size"
    #     ]
    ...
    #                 num_epochs,
    #                 i,
    #                 math.floor(train_iterations / train_batch_size),
    #                 losses,
    #             )
    #             visualizer.plot_current_losses(
    #                 epoch,
    #                 float(i) / math.floor(train_iterations / train_batch_size),
    #                 losses,
    #             )
    ...
    #     print(
    #         "End of epoch {0} / {1} \t Time Taken: {2} sec".format(
    ...
    #         "batch_size"
    #     ] = 1  # set batch size to 1 for tracing
